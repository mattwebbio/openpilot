    ...
    while True:
      ...
      try:
        ...
        prompt = (
          ...
          f"- ONLY change lanes if the car is actively moving (current speed > 5 m/s). NEVER change lanes when stopped or moving very slowly.\n"
          f"- Lane markings MUST be clearly visible and dashed - NEVER cross solid lines or change lanes when markings are not visible.\n"
          f"- There must be adequate space ahead and behind.\n"
          f"- The driver-facing camera (Image 2) must show NO vehicle visible through the side window for the target lane.\n"
